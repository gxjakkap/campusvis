<?php 
    ...
    $result = mysqli_query($connection, 'SELECT table_faculty.id_faculty, id_department, name_department FROM table_faculty LEFT JOIN table_department_master ON table_faculty.id_faculty=table_department_master.id_faculty ORDER BY table_faculty.id_faculty ASC');
    $dep = [];
    while ($row = mysqli_fetch_assoc($result)){
...
<html lang="en">
    <head>
        ...
        <title>แก้ไขสาขาวิชาปริญญาโท</title>
        ...
        <div class="container-fluid">
            <div class="row">
                            ...
                            <div class="modal-body">
                                <div class="input-group">
                                    <form class="w-100" action="actions/adddep.php" method="post">
                                        ...
                                        <input class="d-none" value="mdep" name="ref"/>
                                        <input class="d-none" value="2" name="type"/>
                                    </form>
                                </div>
                            </div>
                        </div>
                            ...
                            <div class="modal-body">
                                ...
                                <div class="input-group">
                                    <form class="w-100" action="actions/updatedep.php" method="post">
                                        ...
                                        <input class="d-none" value="mdep" name="ref"/>
                                        <input class="d-none" name="mdid" id="editHiddenIdBox"/>
                                        <input class="d-none" value="2" name="type"/>
                                    </form>
                                </div>
                            </div>
                            ...
                            <div class="modal-body">
                                <div class="input-group">
                                    ...
                                    <form class="w-100" action="actions/deldep.php" method="post">
                                        ...
                                        <input class="d-none" value="mdep" name="ref"/>
                                        <input class="d-none" value="2" name="type"/>
                                        <input class="d-none" name="mdid" id="deleteHiddenIdBox"/>
                                    </form>
                                </div>
                            </div>
                        </div>
                ...
                <main class="col-md-9 ms-sm-auto col-lg-10 px-md-4">
                    <h1 class="mt-3 mb-5">แก้ไขข้อมูลสาขาวิชา (ปริญญาโท)</h1>
                    <div class="w-full">
                                ...
                                <?php
                                    ...
                                    foreach ($dep as $fid => $deparr){
                                        foreach ($deparr as $id => $depname) {
                                            ...
                                            echo '<td><button class="btn editBtn mr-1" data-bs-toggle="modal" data-bs-target="#editModal" data-bs-id="'. $id .'" data-bs-facname="'. $faculty[$fid] .'" data-bs-name="'. $depname.'">แก้ไข</button><button class="btn deleteBtn ml-1" data-bs-toggle="modal" data-bs-target="#deleteModal" data-bs-id="'. $id .'" data-bs-facname="'. $faculty[$fid] .'" data-bs-name="'. $depname .'">ลบ</button></td>';                                       
                                            echo '</tr>';
                                            $din++;
                                        }
                                    }
